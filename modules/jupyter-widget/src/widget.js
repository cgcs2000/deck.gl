...
const deckgl = require('@cgcs2000/deck.gl.core');
const deckglLayers = require('@cgcs2000/deck.gl.layers');
const deckAggregationLayers = require('@cgcs2000/deck.gl.aggregation-layers');
const deckJson = require('@cgcs2000/deck.gl.json');
